...
if (isset($_POST["submit"])) {
    ...
    if (
    strpos($contents, $email) !== false or
    strpos($contents, $phone) !== false
  ) {
        ...
        <div class="left">
            <form action="Register.php" method="post">
                <div id="left">
                    ...
                    <img id="oval-img" src="Asset/profile.jpg" /><br />
                    <input id="file-input" type="file" name="pic" value="pic" onchange="return change_img(this)" />

                    <!-- first name -->
                    <div class="styled-input-text">
                        <!-- <div class="name"> -->
                        <label for="fname">First name</label>
                        <input type="text" id="fname" placeholder="First name" name="fname" pattern="[\da-zA-Z\s]{3,}" />
                    </div>
                    ...
                    <div class="styled-input-text">
                        ...
                        <input type="text" id="address" placeholder="123 Street" name="address" pattern="[a-zA-Z0-9\s]{3,}" />
                    </div>
                    <div class="styled-input-text">
                        <label for="City">City</label>
                        <input type="text" id="city" placeholder="New York" name="city" pattern="[a-zA-Z\s]{3,}" />
                    </div>
                    <div class="styled-input-text">
                        <label for="Zipcode">Zipcode</label>
                        <input type="text" id="zipcode" name="zipcode" placeholder="000000" pattern="[0-9]{4,6}" />
                    </div>
