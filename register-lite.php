        ...
        <form action="register-lite.php" method="post">
            <div id="left">
                ...
                <input
                        ...
                        name="pic"
                        value="pic"
                        onchange="return change_img(this)"
                />
                        ...
                        <div class="styled-input-text">
                            ...
                            <div class="styled-select">
                                <div class="custom-select">
                                    <select name="category-list" class="styled-select">
                                        <option value="0" disabled selected hidden>
                                            Select a category... ▾
                                        </option>
...
if (isset($_POST['submit'])){
    ...
    $file = 'Data/users.csv';
    // $data =  $email . "," .  $phone .",". $password . ",".$password_hashed. "," .$firstname . "," .$lastname .",". $address . ",". $city ."," . $zipcode. "\n";
    ...
    // if the email doesn't exist => false
    ...
    if (strpos($contents, $phone) === false) {
        // fputcsv($fp, $user_detail);
            ...
            echo("<script>alert('check your phone number');
            location.href='login.php;
            </script>");
