...
<body>
    ...
    <div class="body_spacing">
        <h2>Contact Store</h2>
        <form action="action.php" method="get" class="form" id="form">
            <!-- Contact purpose -->
            ...
            <div class="styled-input-text">
                ...
                <input type="text" id="name" name="name" placeholder="Name" pattern="^[a-zA-Z]{3,}$" />
            ...
            <div class="styled-textarea">
                ...
                <textarea name="Message" id="Message" placeholder="What's your message?" minlength="50" maxlength="500" required></textarea>
