...
<head>
    <meta charset="utf-8" />
    <title>Store Terms of Service</title>
    <meta name="description" content="Store Terms of Service" />
    ...
    <div class="body_spacing">
        ...
        <div>
            ...
            <p>
                ...
                use of our store's Website, located at
                https://s3800978.github.io/WebProg-HTML-and-CSS/.
            </p>

            <p>
                By accessing this website we assume you accept these terms and
                conditions. Do not continue to use our store if you do not
            ...
            <p>
                We employ the use of cookies. By accessing our store, you
                agreed to use cookies in agreement with the our store's
                Privacy Policy.
            </p>
            ...
            <p>
                Unless otherwise stated, our store and/or its licensors own
                the intellectual property rights for all material on Ziugei General
                Goods. All intellectual property rights are reserved. You may access
                this from our store for your own personal use subjected to
                restrictions set in these terms and conditions.
            </p>

            <p>You must not:</p>
            <ul>
                <li>Republish material from our store</li>
                <li>Sell, rent or sub-license material from our store</li>
                <li>Reproduce, duplicate or copy material from our store</li>
                <li>Redistribute content from our store</li>
            </ul>
            ...
            <p>
                ...
                our store does not filter, edit, publish or review Comments
                prior to their presence on the website. Comments do not reflect the
                views and opinions of our store,its agents and/or affiliates.
                Comments reflect the views and opinions of the person who post their
                views and opinions. To the extent permitted by applicable laws, Ziugei
                Tech Store shall not be liable for the Comments or for any liability,
            ...
            <p>
                our store reserves the right to monitor all Comments and to
            ...
            <p>
                You hereby grant our store a non-exclusive license to use,
            ...
            <p>
                ...
                the hyperlink compensates the absence of our store; and (d)
            ...
            <p>
                ...
                sending an e-mail to our store. Please include your name, your
            ...
            <p>
                No use of our store's logo or other artwork will be allowed
